		...
		<div class="container">
			...
			<div class="article">
				<div class="row">
					...
					<!-- video player -->
					<div class="col-12 col-xl-8">
						<video controls crossorigin playsinline poster="<?php echo base_url().'assets/movies/'.$row->picture;?>" id="player">
							<!-- Video files -->
					...
					<div class="col-12 col-xl-8">
						...
						<div class="categories">
							...
							<?php 
									...
									$cat = $this->db->get('movie_categories')->result();
									foreach ($cat as $val_cat) {
										echo '<a href="'.base_url(`category/`).$val_cat->id.'" class="categories__item">'.$val_cat->name.'</a>';
									}
									?>
						</div>
						<!-- end categories -->
